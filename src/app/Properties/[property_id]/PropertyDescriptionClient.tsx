// ── src/app/Properties/[property_id]/PropertyDescriptionClient.tsx ──
'use client'
...
export default function PropertyDescriptionClient({ params }: Params) {
    ...
    () => [
      {
        ...
        property_specifications: [
          {
            year_built: { value: 2005, label: 'Year Built' },
            lot_size: { value: 4500, label: 'Lot Size (sqft)' },
            energy_rating: { value: 'A+', label: 'Energy Rating' },
            smart_system: { value: 'Yes', label: 'Smart System' },
            security_system: { value: 'Advanced', label: 'Security System' },
            sustainability: { value: 'High', label: 'Sustainability' },
            connectivity: { value: 'High', label: 'Connectivity' },
            wellness_features: { value: 'Yes', label: 'Wellness Features' },
          },
        ],
      ...
      },
      {
        ...
        num_bathrooms: 4,
        primaryImage:
          'https://images.unsplash.com/photo-1605146768851-eda79da39897?q=80&w=2940&auto=format&fit=crop',
        additionalImages: [
          {
            base64Image:
              'https://images.unsplash.com/photo-1605146768851-eda79da39897?q=80&w=2940&auto=format&fit=crop',
  ...
  useEffect(() => {
    const found = fakeDataProperties.find((p) => p.property_id === property_id)
    if (found) setCurrentProperty(found)
