...
const Signup = () => {
    ...
    return (
        <Flex className='Login-Overlay' justify='center' align='center'>
            <Flex vertical className='Login-Inner' justify='center' align='center' gap={20}>
            <Link href="/"><img src="logo/logoLogin.svg" alt="Global property Logo" /></Link>

                <h2>Create an account</h2>
                <p>Create, explore, and experience websites beyond</p>
                <Form className='login-form' onFinish={HandleSubmit} form={form}>
                    <Form.Item name="username" className='login-form-item' rules={[RequiredField]}>
                        <Input placeholder="Choose a username" required type='text'/>
                    </Form.Item>
                    <Form.Item name="email" className='login-form-item' rules={[RequiredField, EmailValidation]}>
                        <Input placeholder="Email address" required type='email'/>
                    </Form.Item>
                    <Form.Item name="password" className='login-form-item' rules={[RequiredField]}>
                        <Input placeholder="Password" required type='password'/>
                    </Form.Item>
                    <Form.Item name="confirm_password" dependencies={['password']} hasFeedback rules={[RequiredField, ConfirmPassword]}>
            ...
            <Link href="/" ><LeftOutlined /> Go back</Link>
            </Flex>
        </Flex>
    )
}
