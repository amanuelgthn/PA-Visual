// File: src/app/admin/properties/edit/[propertyId]/page.tsx
...
//
// 1) “properties” array must live at the top‐level so that
//    generateStaticParams() can see every propertyId at build time.
//
const properties: PropertyListTableTypes[] = [
  {
    propertyId: '1',
  ...
  },
  {
    ...
    propertyDescription: 'This is a modern apartment located in New York, NY.',
  ...
  },
  {
    ...
    propertyDescription: 'This is a cozy cottage located in Napa Valley, CA.',
  ...
  },
  {
    ...
    propertyDescription: 'This is a luxurious penthouse located in Miami, FL.',
  ...
  },
  {
    ...
    propertyDescription: 'This is a beautiful farmhouse located in Austin, TX.',
  ...
  },
  {
    ...
    propertyDescription: 'This is a cozy mountain cabin located in Aspen, CO.',
...
//
// 2) Next.js needs generateStaticParams() for any dynamic route under “output: export”.
//    This tells Next.js “here are all of the propertyId values to pre-render at build time.”
//
...
//
// 3) Default export runs as a Server Component. We look up “initialData” here and
//    then hand it off to your client component (<PropertyForms />).
//
export default function EditPropertyPage({
  ...
  const initialData = properties.find((p) => p.propertyId === params.propertyId)

  return (
    <div>
      {/* If you need to handle “not found” differently, you can check initialData == null here */}
