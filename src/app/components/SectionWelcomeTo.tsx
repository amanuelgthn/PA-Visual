      ...
      <section className={`${styles.welcomeSection} ${styles.section}`}>
        <div className={styles.welcomeToGa}>
          ...
          <p>
            ...
            internationally, offering exclusive services tailored to meet the
            needs of our most discerning clients. Whether you are looking to
            buy, sell, or invest, our dedicated team is here to provide
        ...
        <div className={styles.experienceUnderSection}>
          ...
          <div className={styles.explanationCards}>
            <div className={styles.card}>
              ...
              <p>
                Explore our handpicked selection of luxury homes and estates.
              </p>
            </div>
            <div className={styles.card}>
              <h1>Investment Advisory</h1>
              <p>
                Get expert advice on the best real estate investment
                opportunities.
              </p>
            </div>
            <div className={styles.card}>
              ...
              <p>
                Work with our skilled architects and interior designers to
            ...
            <div className={styles.card}>
              ...
              <p>
                Benefit from our innovative use of artificial intelligence to
                streamline processes and enhance your experience.
              </p>
            </div>
          </div>
        </div>
